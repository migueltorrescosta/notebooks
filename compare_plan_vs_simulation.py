"""
Compare the expectations set by reports/2026-05-07/2026-05-07-High-Order-Squeezing-Plan.md
...
def run_all_tests() -> None:
    ...
    print("=" * 60)
    print("\nPlan: reports/2026-05-07/2026-05-07-High-Order-Squeezing-Plan.md")
