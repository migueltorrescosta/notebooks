...
with tab_about:
    st.markdown(
        ...
        **References**:
        - Report `2026-05-12-Ancilla-Assisted-Metrology-Optimization` (passive ancilla)
        - Report `2026-05-15-Ancilla-Assisted-Metrology-Joint-Measurement`
