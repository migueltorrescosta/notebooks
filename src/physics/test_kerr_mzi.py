...
class TestKerrPhaseShiftUnitary:
    ...
    def test_given_same_chi_t_product_then_same_unitary(self) -> None:
    ...
    def test_given_negative_chi_then_raises_valueerror(self) -> None:
...
class TestKerrMzi:
    ...
    def test_given_zero_phi_chi_then_fringe_balanced(self) -> None:
