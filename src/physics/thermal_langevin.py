"""
Thermal Langevin Noise Model for Interferometry.

This module implements thermal noise limits for interferometric phase
estimation, where a thermal Langevin force creates a phase-noise floor.
