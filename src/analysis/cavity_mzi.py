"""Cavity-enhanced Mach-Zehnder interferometer models.

Implements cavity-enhanced MZI with ℱ-fold phase accumulation, both
noiseless (unitary) and noisy (Lindblad) evolution, and sensitivity
computation via QFI.
...
def cavity_enhanced_mzi_with_noise(
    ...
    Noise channels (per pass):
        ...
        | Phase diffusion| √γ_phi J_z          | Dephasing between arms         |
    ...
    Args:
        ...
        noise_gamma_2: Two-body loss rate (γ₂) per pass for mode 1.
            Must be non-negative.
        noise_gamma_phi: Phase diffusion rate (γ_phi) per pass between
