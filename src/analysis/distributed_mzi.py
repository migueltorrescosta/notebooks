"""Distributed interferometer array models.

Implements sensitivity analysis for distributed (multi-sensor) interferometer
arrays with classical averaging, entangled (collective Heisenberg-limited)
operation, correlated noise models, and scaling exponents.
