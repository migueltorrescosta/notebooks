...
All three sweeps (A, B, C) completed successfully. 63/63 tests pass. Raw data saved as Parquet files in `raw_data/`, figures saved as SVGs in `figures/`. **See** `reports/20260630/noise_comparison_mzi.py` and `test_noise_comparison_mzi.py` for the implementing code and test suite.
