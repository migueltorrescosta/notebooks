...
Usage:
    uv run python reports/r20260527/drive_component_analysis.py --force

This module is importable via ``importlib.import_module("reports.r20260527.drive_component_analysis")``.
"""
