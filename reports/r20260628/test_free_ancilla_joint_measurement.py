...
Companion test module for ``reports/r20260628/free_ancilla_joint_measurement.py``.
...
_m = importlib.import_module("reports.r20260628.free_ancilla_joint_measurement")
