...
**See**: `compute_decoupled_baseline()` in `local.py`; data in `2026-05-22-dual-mzi-decoupled-baseline.parquet` and `2026-05-22-dual-mzi-decoupled-baseline-full.parquet`; figure `2026-05-22-dual-mzi-decoupled-baseline.svg`.
...
**See**: `optimise_alpha_xx()` and `run_sweep()` in `local.py`; data in `2026-05-22-dual-mzi-sweep.parquet`; figures `2026-05-22-dual-mzi-ratio-heatmap.svg` (uniform at 1.0) and `2026-05-22-dual-mzi-alpha-opt-heatmap.svg` (uniform at 0).
...
**See**: `fit_scaling_exponents()` in `local.py`; data in `2026-05-22-dual-mzi-scaling.parquet`.

![N-scaling at θ=1.0: data lies exactly on the SQL line, confirming the null hypothesis.](figures/2026-05-22-dual-mzi-n-scaling-theta1.0.svg)
...
![Scaling exponents: α = −0.5 for all θ with R² = 1.0.](figures/2026-05-22-dual-mzi-scaling-exponents.svg)
...
![θ-dependence at N=5: flat at SQL across the full θ range.](figures/2026-05-22-dual-mzi-theta-N5.svg)
