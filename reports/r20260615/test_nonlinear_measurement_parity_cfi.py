...
Companion test module for ``reports/r20260615/nonlinear_measurement_parity_cfi.py``.
...
_m = importlib.import_module("reports.r20260615.nonlinear_measurement_parity_cfi")
