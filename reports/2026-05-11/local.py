...
Usage:
    uv run python reports/2026-05-11/local.py --force
    uv run python reports/2026-05-11/local.py --experiment ancilla-vs-system --force
...
_pseudomode_local_path = (
    Path(__file__).resolve().parent.parent / "2026-05-09" / "local.py"
)
...
assert _pseudomode_spec is not None, (
    f"Could not find 2026-05-09/local.py at {_pseudomode_local_path}"
)
