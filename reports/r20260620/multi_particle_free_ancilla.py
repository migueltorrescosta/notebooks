...
Usage:
    uv run python reports/r20260620/multi_particle_free_ancilla.py
    uv run python reports/r20260620/multi_particle_free_ancilla.py --force
"""
...
def generate_n_scaling_scan(force: bool = False) -> None:
    ...
    checkpoint_dir = REPORTS_DIR / f"r{REPORT_DATE}" / "raw_data" / "checkpoints"
...
def main() -> None:
    ...
    for d in ["raw_data", "figures"]:
        (REPORTS_DIR / f"r{REPORT_DATE}" / d).mkdir(parents=True, exist_ok=True)
