...
Usage:
    uv run python reports/r20260520/xx_coupling_ancilla.py --force

This module is importable via ``importlib.import_module("reports.r20260520.xx_coupling_ancilla")``.
"""
...
def main() -> None:
    ...
    (REPORTS_DIR / f"r{XX_DATE}" / "raw_data").mkdir(parents=True, exist_ok=True)
    (REPORTS_DIR / f"r{XX_DATE}" / "figures").mkdir(parents=True, exist_ok=True)
