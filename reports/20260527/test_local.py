...
Run with:
    uv run pytest reports/20260527/test_local.py -q --tb=short
"""
...
_report_dir = str(
    Path(__file__).resolve().parent.parent.parent / "reports" / "20260527",
)
...
def test_cli_help() -> None:
    ...
    result = subprocess.run(  # noqa: PLW1510  # check handled by assert
        [
            "uv",
            "run",
            "python",
