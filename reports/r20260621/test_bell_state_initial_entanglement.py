...
Companion test module for ``reports/r20260621/bell_state_initial_entanglement.py``.
...
_m = importlib.import_module("reports.r20260621.bell_state_initial_entanglement")
...
class TestPipeline:
    ...
    def test_run_single_scenario_a(self) -> None:
        ...
        result = run_single_scenario_omega(
            Scenario.A, 1.0, n_random=50, n_nm_refine=5, seed=42
        )
    ...
    def test_run_single_scenario_b(self) -> None:
        result = run_single_scenario_omega(
            Scenario.B, 1.0, n_random=50, n_nm_refine=5, seed=42
        )
        assert isinstance(result, BellOptimisationResult)
    ...
    def test_run_single_scenario_c(self) -> None:
        result = run_single_scenario_omega(
            Scenario.C, 1.0, n_random=50, n_nm_refine=5, seed=42
        )
        assert isinstance(result, BellOptimisationResult)
