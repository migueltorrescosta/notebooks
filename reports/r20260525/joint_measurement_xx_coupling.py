...
Usage:
    uv run python reports/r20260525/joint_measurement_xx_coupling.py --force

This module is importable via ``importlib.import_module("reports.r20260525.joint_measurement_xx_coupling")``.
"""
...
def generate_comparison_traced_out(force: bool = False) -> None:
    ...
    traced_path = (
        REPORTS_DIR / "r20260522" / "raw_data" / "20260522-dual-mzi-sweep.parquet"
    )
