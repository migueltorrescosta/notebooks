...
Run with:
    uv run pytest reports/r20260601/test_heisenberg_limit_noon_twinfock.py -q --tb=short
"""
...
_m = importlib.import_module("reports.r20260601.heisenberg_limit_noon_twinfock")
        ...
        result = subprocess.run(
            [
                ...
                str(
                    ...
                    / "heisenberg_limit_noon_twinfock.py"
                ),
                "--help",
            ],
            capture_output=True,
