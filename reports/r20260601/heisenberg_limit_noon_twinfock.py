...
Usage:
    uv run python reports/r20260601/heisenberg_limit_noon_twinfock.py --force
    uv run python reports/r20260601/heisenberg_limit_noon_twinfock.py --only noon
    uv run python reports/r20260601/heisenberg_limit_noon_twinfock.py --only twin_fock_std

This module is importable via ``importlib.import_module("reports.r20260601.heisenberg_limit_noon_twinfock")``.
"""
