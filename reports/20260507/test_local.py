...
embed_hybrid_in_mzi = _report_local.embed_hybrid_in_mzi
evolve_hybrid_lindblad = _report_local.evolve_hybrid_lindblad
evolve_hybrid_mzi = _report_local.evolve_hybrid_mzi
...
lindblad_rhs = _report_local.lindblad_rhs
mzi_beam_splitter = _report_local.mzi_beam_splitter
mzi_marginal_photon_probs = _report_local.mzi_marginal_photon_probs
mzi_output_probabilities = _report_local.mzi_output_probabilities
mzi_phase_generator = _report_local.mzi_phase_generator
mzi_phase_shift = _report_local.mzi_phase_shift
...
validate_hybrid_unitary = _report_local.validate_hybrid_unitary
