...
Companion test module for ``reports/r20260612/multi_particle_ancilla_omega_drive.py``.
...
_m = importlib.import_module("reports.r20260612.multi_particle_ancilla_omega_drive")
T_BS = _m.T_BS
T_HOLD = _m.T_HOLD
