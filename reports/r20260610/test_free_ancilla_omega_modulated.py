...
Run with:
    uv run pytest reports/r20260610/test_free_ancilla_omega_modulated.py -q --tb=short
"""
...
_m = importlib.import_module("reports.r20260610.free_ancilla_omega_modulated")
...
def test_cli_help() -> None:
    ...
    result = subprocess.run(
        [
            ...
            "run",
            "python",
            str(Path(__file__).resolve().parent / "free_ancilla_omega_modulated.py"),
            "--help",
        ],
        capture_output=True,
        text=True,
