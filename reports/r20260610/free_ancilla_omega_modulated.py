...
Usage:
    uv run python reports/r20260610/free_ancilla_omega_modulated.py --force
    uv run python reports/r20260610/free_ancilla_omega_modulated.py --only stage-1-slice
"""
