...
Usage:
    uv run python reports/2026-05-19/local.py --force
    uv run python reports/2026-05-19/local.py --only phase-decoupled-baseline

This module is **not** importable as ``reports.2026-05-19.local`` (the directory
