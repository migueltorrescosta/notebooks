...
Usage:
    uv run python reports/r20260528/free_ancilla_initial_state.py --force

This module is importable via ``importlib.import_module("reports.r20260528.free_ancilla_initial_state")``.
"""
