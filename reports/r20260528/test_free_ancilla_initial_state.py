...
Run with:
    uv run pytest reports/r20260528/test_free_ancilla_initial_state.py -q --tb=short
"""
...
_m = importlib.import_module("reports.r20260528.free_ancilla_initial_state")
...
def test_cli_help() -> None:
    ...
    result = subprocess.run(
        [
            ...
            "run",
            "python",
            str(Path(__file__).resolve().parent / "free_ancilla_initial_state.py"),
            "--help",
        ],
        capture_output=True,
        text=True,
