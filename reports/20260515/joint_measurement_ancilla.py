...
Usage:
    uv run python reports/20260515/joint_measurement_ancilla.py --force

This module is importable via ``importlib.import_module("reports.20260515.joint_measurement_ancilla")``.
"""
