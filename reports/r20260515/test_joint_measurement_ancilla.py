...
Run with:
    uv run pytest reports/r20260515/test_joint_measurement_ancilla.py -q --tb=short
"""
...
_m = importlib.import_module("reports.r20260515.joint_measurement_ancilla")
...
class TestModuleLoading:
    ...
    def test_reports_dir_is_parent(self) -> None:
        assert (_m.REPORTS_DIR / "r20260515").resolve() == Path(
            __file__
        ).resolve().parent
