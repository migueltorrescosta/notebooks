...
Usage:
    uv run python reports/r20260515/joint_measurement_ancilla.py --force

This module is importable via ``importlib.import_module("reports.r20260515.joint_measurement_ancilla")``.
"""
