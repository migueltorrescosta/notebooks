...
Usage:
    uv run python reports/r20260507/high_order_squeezing.py
    uv run python reports/r20260507/high_order_squeezing.py --force  (regenerate data + figures)

This module is importable via ``importlib.import_module("reports.r20260507.high_order_squeezing")``.
"""
...
# Re-export for backward compatibility with test_high_order_squeezing.py bindings
...
def run_all_tests() -> None:
    ...
    print("=" * 60)
    print("\nPlan: reports/r20260507/High-Order-Squeezing-Plan.md")
...
if __name__ == "__main__":
    ...
    if args.force:
        ...
        print(
            "Use `uv run python reports/r20260507/high_order_squeezing.py --force` to regenerate "
            "data and figures.",
        )
        print()
        run_all_tests()
