...
"""
import importlib.util, sys, time, numpy as np, pandas as pd
...
for N in [11, 12, 13]:
    ...
    for omega in module.OMEGA_VALS_N_SCALING:
        ...
        results.append({
            ...
            "alpha_xx_opt": float(best_params[3]), "alpha_xz_opt": float(best_params[4]),
            "alpha_zx_opt": float(best_params[5]), "alpha_zz_opt": float(best_params[6]),
