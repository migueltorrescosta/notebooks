...
Usage:
    uv run python reports/r20260518/ancilla_drive_enhanced_metrology.py --force

This module is importable via ``importlib.import_module("reports.r20260518.ancilla_drive_enhanced_metrology")``.
"""
...
def run_n_scaling_sweep(force: bool = False) -> None:
