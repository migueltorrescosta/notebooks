...
This is the companion test module for ``ancilla_drive_enhanced_metrology.py`` in this directory.
...
Run with:
    uv run pytest reports/r20260518/test_ancilla_drive_enhanced_metrology.py -q --tb=short
"""
...
_m = importlib.import_module("reports.r20260518.ancilla_drive_enhanced_metrology")
