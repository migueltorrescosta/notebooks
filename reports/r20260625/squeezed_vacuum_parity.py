...
Usage:
    ...
    uv run python reports/r20260625/squeezed_vacuum_parity.py --force

This module is importable via ``importlib.import_module("reports.r20260625.squeezed_vacuum_parity")``.
"""
