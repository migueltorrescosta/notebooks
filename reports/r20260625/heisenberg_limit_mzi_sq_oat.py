...
Usage:
    uv run python reports/r20260625/heisenberg_limit_mzi_sq_oat.py --force
    uv run python reports/r20260625/heisenberg_limit_mzi_sq_oat.py --only sv
    uv run python reports/r20260625/heisenberg_limit_mzi_sq_oat.py --only oat

This module is importable via ``importlib.import_module("reports.r20260625.heisenberg_limit_mzi_sq_oat")``.
"""
