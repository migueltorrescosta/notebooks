...
Run with:
    uv run pytest reports/r20260625/test_heisenberg_limit_mzi_sq_oat.py -q --tb=short
"""
...
_m = importlib.import_module("reports.r20260625.heisenberg_limit_mzi_sq_oat")
