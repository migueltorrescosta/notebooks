...
Usage:
    uv run python reports/r20260521/general_interaction_ancilla.py --force

This module is importable via ``importlib.import_module("reports.r20260521.general_interaction_ancilla")``.
"""
...
DATE_TAG = "20260521"
BFGS_TABLE_DIR = str(REPORTS_DIR / f"r{DATE_TAG}" / "raw_data" / "bfgs-results")
...
def main() -> None:
    ...
    (REPORTS_DIR / f"r{DATE_TAG}" / "raw_data").mkdir(parents=True, exist_ok=True)
    (REPORTS_DIR / f"r{DATE_TAG}" / "figures").mkdir(parents=True, exist_ok=True)
