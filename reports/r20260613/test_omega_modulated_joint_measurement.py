...
Companion test module for ``reports/r20260613/omega_modulated_joint_measurement.py``.
...
_m = importlib.import_module("reports.r20260613.omega_modulated_joint_measurement")
T_BS = _m.T_BS
T_HOLD = _m.T_HOLD
...
class TestN1Consistency:
    ...
    def test_given_N1_omega02_then_beats_sql(self) -> None:
        ...
        """
        result = run_single_joint_n_omega(
            N=1, omega=0.2, n_random=50, n_nm_refine=5, seed=42, maxiter=500
        )
