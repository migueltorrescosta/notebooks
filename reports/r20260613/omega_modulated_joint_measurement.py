...
Usage:
    uv run python reports/r20260613/omega_modulated_joint_measurement.py --force
"""
...
def joint_2d_psi_azz_slice(
    ...
    def _sensitivity(pv: float, av: float) -> float:
    ...
    grid = sequential_grid_scan(psi_vals, azz_vals, _sensitivity)
