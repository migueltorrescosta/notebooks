...
Run with:
    uv run pytest reports/20260525/test_joint_measurement_xx_coupling.py -q --tb=short
"""
...
_m = importlib.import_module("reports.20260525.joint_measurement_xx_coupling")
