...
Usage:
    uv run python reports/r20260522/multi_particle_xx_coupling.py --force

This module is importable via ``importlib.import_module("reports.r20260522.multi_particle_xx_coupling")``.
"""
