...
Covers: operator construction, CSS states, beam-splitter unitaries,
circuit evolution, weighted measurement, golden-section sub-optimisation,
sensitivity computation, analytical benchmarks, optimisation, scaling.
"""
...
class TestBeamSplitter:
    ...
    def test_subsystem_bs_unitary(self, N: int, T: float) -> None:
        from src.analysis.weighted_joint_measurement import bs_unitary_np
